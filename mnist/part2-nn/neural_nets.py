...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        vfun_hidden_deriv = np.vectorize(rectified_linear_unit_derivative)
        dLdf1 = self.hidden_to_output_weights.T * output_layer_error
        hidden_layer_error = vfun_hidden_deriv(dLdf1)
